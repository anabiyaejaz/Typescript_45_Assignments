...
// a message saying3 that the username is available. 
// • Make sure your comparison is case insensitive. If 'John' has been used, 'JOHN' should not be 
// accepted. 

let current_users: string[] = ["FaRah", "ZarA", "Rehmat", "Unzila", "ZaInab"];

let new_users: string[] = ["FaTima", "Iqra", "ZaInab", "Sana", "FaRah"];
...
if(current_users.map(c_user => c_user.toLowerCase()).includes(lowerCase)) {
    ...
    console.log(`The usernsme ${newUserName} is available.`);
}
});